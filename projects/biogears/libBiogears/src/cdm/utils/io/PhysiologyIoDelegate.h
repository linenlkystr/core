...
namespace io {
  class BIOGEARS_PRIVATE_API PhysiologyIoDelegate {
  public:
    ...
    //class SEInflammationState
    static void Marshall(const CDM::InflammationStateData& in, SEInflammationState& out);
    static void UnMarshall(const SEInflammationState& in, CDM::InflammationStateData& out);
    //class SEBloodChemistrySystem
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PhysiologyIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PhysiologyIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

...
namespace io {
  class BIOGEARS_PRIVATE_API PatientActionsIoDelegate {
  public:
    //class SEActionList;
    ...
    //class SESepsis;
    static void Marshall(const CDM::SepsisData& in, SESepsis& out);
    static void UnMarshall(const SESepsis& in, CDM::SepsisData& out);
    //class SEIntubation;
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientActionsIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientActionsIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

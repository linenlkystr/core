...
namespace io {
  class BIOGEARS_PRIVATE_API PatientAssessmentsIoDelegate {
  public:
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientAssessmentsIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientAssessmentsIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

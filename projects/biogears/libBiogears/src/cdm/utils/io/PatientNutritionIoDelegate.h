...
namespace io {
  class BIOGEARS_PRIVATE_API PatientNutritionIoDelegate {
  public:
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientNutritionIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientNutritionIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

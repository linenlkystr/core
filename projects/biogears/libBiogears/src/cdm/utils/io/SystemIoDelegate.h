...
namespace io {
  class BIOGEARS_PRIVATE_API SystemIoDelegate {
  public:
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void SystemIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void SystemIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

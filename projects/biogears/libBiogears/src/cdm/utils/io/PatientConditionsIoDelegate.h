...
namespace io {
  class BIOGEARS_PRIVATE_API PatientConditionsIoDelegate {
  public:
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientConditionsIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientConditionsIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

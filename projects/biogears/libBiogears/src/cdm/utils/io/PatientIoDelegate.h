...
namespace io {
  class BIOGEARS_PRIVATE_API PatientIoDelegate {
  public:
    ...
    //class SEActivePatientEvent
    static void Marshall(const CDM::ActivePatientEventData& in, SEActivePatientEvent& out);
    static void UnMarshall(const SEActivePatientEvent& in, CDM::ActivePatientEventData& out);
    //class SEPatient
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void PatientIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

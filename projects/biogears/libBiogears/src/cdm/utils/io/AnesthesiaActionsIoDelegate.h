...
namespace io {
  class BIOGEARS_PRIVATE_API AnesthesiaActionsIoDelegate {
  public:
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void AnesthesiaActionsIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void AnesthesiaActionsIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

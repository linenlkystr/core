...
class SEActiveAnesthesiaMachineEvent;
...
namespace io {
  class BIOGEARS_PRIVATE_API SubstanceQuantityIoDelegate {
  public:
    ...
    //class SEActiveAnesthesiaMachineEvent
    static void Marshall(const CDM::ActiveAnesthesiaMachineEventData& in, SEActiveAnesthesiaMachineEvent& out);
    static void UnMarshall(const SEActiveAnesthesiaMachineEvent& in, CDM::ActiveAnesthesiaMachineEventData& out);
    //class SEAnesthesiaMachine
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void SubstanceQuantityIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void SubstanceQuantityIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

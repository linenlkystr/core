...
namespace io {
  class BIOGEARS_PRIVATE_API EngineStateIoDelegate {
  public:
    ...
    //class SEPhysiologyEngineState
    static void Marshall(const CDM::PhysiologyEngineStateData& in, SEPhysiologyEngineState& out);
    static void UnMarshall(const SEPhysiologyEngineState& in, CDM::PhysiologyEngineStateData& out);
  };
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void EngineStateIoDelegate::Marshall(xsd::cxx::tree::optional<XSD> const& option_in, SE& out)
  {
  ...
  //----------------------------------------------------------------------------------
  template <typename SE, typename XSD>
  void EngineStateIoDelegate::UnMarshall(const SE& in, xsd::cxx::tree::optional<XSD>& option_out)
  {

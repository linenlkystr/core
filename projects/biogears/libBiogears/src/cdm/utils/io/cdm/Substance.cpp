...
namespace io {
  ...
  {
    out.Clear();
    io::Property::Marshall(in.AcidDissociationConstant(), out.GetAcidDissociationConstant());
    ...
    if (in.OralAbsorptionRateConstant().present()) {
      io::Property::Marshall(in.OralAbsorptionRateConstant(), out.GetOralAbsorptionRateConstant());
    }
  }
  //-----------------------------------------------------------------------------
  void Substance::UnMarshall(const SESubstancePhysicochemicals& in, CDM::SubstancePhysicochemicalData& out)
  {
    if (in.HasAcidDissociationConstant()) {
      io::Property::UnMarshall(*in.m_AcidDissociationConstant, out.AcidDissociationConstant());
    }
    ...
    if (in.HasOralAbsorptionRateConstant()) {
      io::Property::UnMarshall(*in.m_OralAbsorptionRateConstant, out.OralAbsorptionRateConstant());
    }
  }
  //-----------------------------------------------------------------------------
  ...
  {
    io::Property::Marshall(in.Bronchodilation(), out.GetBronchodilation());
    io::Property::Marshall(in.DiastolicPressureModifier(), out.GetDiastolicPressureModifier());
    io::Property::Marshall(in.EC50(), out.GetEC50());
    io::Property::Marshall(in.EMaxShapeParameter(), out.GetEMaxShapeParameter());
    io::Property::Marshall(in.HeartRateModifier(), out.GetHeartRateModifier());
    io::Property::Marshall(in.NeuromuscularBlock(), out.GetNeuromuscularBlock());
    out.GetPupillaryResponse().Load(in.PupillaryResponse());
    io::Property::Marshall(in.RespirationRateModifier(), out.GetRespirationRateModifier());
    io::Property::Marshall(in.Sedation(), out.GetSedation());
    io::Property::Marshall(in.SystolicPressureModifier(), out.GetSystolicPressureModifier());
    io::Property::Marshall(in.TidalVolumeModifier(), out.GetTidalVolumeModifier());
    io::Property::Marshall(in.TubularPermeabilityModifier(), out.GetTubularPermeabilityModifier());
    io::Property::Marshall(in.CentralNervousModifier(), out.GetCentralNervousModifier());
    io::Property::Marshall(in.EffectSiteRateConstant(), out.GetEffectSiteRateConstant());
    out.CalculateDerived();
  }
  //-----------------------------------------------------------------------------
  void Substance::UnMarshall(const SESubstancePharmacodynamics& in, CDM::SubstancePharmacodynamicsData& out)
  {
    if (in.HasBronchodilation()) {
      io::Property::UnMarshall(*in.m_Bronchodilation, out.Bronchodilation());
    }
    if (in.HasDiastolicPressureModifier()) {
      io::Property::UnMarshall(*in.m_DiastolicPressureModifier, out.DiastolicPressureModifier());
    };
    if (in.HasEC50()) {
    ...
    if (in.HasHeartRateModifier()) {
      io::Property::UnMarshall(*in.m_HeartRateModifier, out.HeartRateModifier());
    }
    if (in.HasNeuromuscularBlock()) {
      io::Property::UnMarshall(*in.m_NeuromuscularBlock, out.NeuromuscularBlock());
    }
    if (in.HasPupillaryResponse()) {
      out.PupillaryResponse(std::unique_ptr<CDM::PupillaryResponseData>(in.m_PupillaryResponse->Unload()));
    }
    if (in.HasRespirationRateModifier()) {
      io::Property::UnMarshall(*in.m_RespirationRateModifier, out.RespirationRateModifier());
    }
    if (in.HasSedation()) {
      io::Property::UnMarshall(*in.m_Sedation, out.Sedation());
    }
    if (in.HasSystolicPressureModifier()) {
      io::Property::UnMarshall(*in.m_SystolicPressureModifier, out.SystolicPressureModifier());
    }
    if (in.HasTidalVolumeModifier()) {
      io::Property::UnMarshall(*in.m_TidalVolumeModifier, out.TidalVolumeModifier());
    }
    if (in.HasTubularPermeabilityModifier()) {
      io::Property::UnMarshall(*in.m_TubularPermeabilityModifier, out.TubularPermeabilityModifier());
    }
    if (in.HasCentralNervousModifier()) {
      io::Property::UnMarshall(*in.m_CentralNervousModifier, out.CentralNervousModifier());
    }
  ...
  void Substance::Marshall(const CDM::SubstanceCompoundData& in, const SESubstanceManager& subMgr, SESubstanceCompound& out)
  {
    ...
    for (unsigned int i = 0; i < in.Component().size(); i++) {
      ...
      out.m_cComponents.push_back(cc);
    }
  }
  //-----------------------------------------------------------------------------

...
namespace io {
  ...
  void PatientNutrition::Marshall(const CDM::NutritionData& in, SENutrition& out)
  {
    ...
    io::Property::Marshall(in.CarbohydrateDigestionRate(), out.GetCarbohydrateDigestionRate());
    io::Property::Marshall(in.Fat(), out.GetFat());
    io::Property::Marshall(in.FatDigestionRate(), out.GetFatDigestionRate());
    io::Property::Marshall(in.Protein(), out.GetProtein());
    io::Property::Marshall(in.ProteinDigestionRate(), out.GetProteinDigestionRate());
  ...
  void PatientNutrition::UnMarshall(const SENutrition& in, CDM::NutritionData& out)
  {
    ...
    if (in.m_CarbohydrateDigestionRate != nullptr) {
      io::Property::UnMarshall(*in.m_CarbohydrateDigestionRate, out.CarbohydrateDigestionRate());
    }
    if (in.m_Fat != nullptr) {
      io::Property::UnMarshall(*in.m_Fat, out.Fat());
    }
    if (in.m_FatDigestionRate != nullptr) {
      io::Property::UnMarshall(*in.m_FatDigestionRate, out.FatDigestionRate());
    }
    if (in.m_Protein != nullptr) {
      io::Property::UnMarshall(*in.m_Protein, out.Protein());
    }
    if (in.m_ProteinDigestionRate != nullptr) {
      io::Property::UnMarshall(*in.m_ProteinDigestionRate, out.ProteinDigestionRate());
    }

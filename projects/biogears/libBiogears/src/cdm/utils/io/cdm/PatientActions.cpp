...
namespace io {
  ...
  void PatientActions::Marshall(const CDM::ExerciseData& in, SEExercise& out)
  {
    ...
    if (in.Intensity().present()) {
      io::Property::Marshall(in.Intensity(), out.GetIntensity());
    } else if (in.DesiredWorkRate().present()) {
      io::Property::Marshall(in.DesiredWorkRate(), out.GetDesiredWorkRate());
    }
  }
  //----------------------------------------------------------------------------------
  void PatientActions::UnMarshall(const SEExercise& in, CDM::ExerciseData& out)
  {
    ...
    if (in.m_Intensity != nullptr) {
      io::Property::UnMarshall(*in.m_Intensity, out.Intensity());
    }
    if (in.m_DesiredWorkRate != nullptr) {
      io::Property::UnMarshall(*in.m_DesiredWorkRate, out.DesiredWorkRate());
    }
  }
  //----------------------------------------------------------------------------------
  //class SEHemorrhage
  ...
  //----------------------------------------------------------------------------------
  //class SESepsis
  void PatientActions::Marshall(const CDM::SepsisData& in, SESepsis& out)
  {
    Scenario::Marshall(static_cast<const CDM::PatientActionData&>(in), static_cast<SEPatientAction&>(out));
    out.m_Compartment = in.Compartment();
    io::Property::Marshall(in.Severity(), out.GetSeverity());
  ...
  //----------------------------------------------------------------------------------
  void PatientActions::UnMarshall(const SESepsis& in, CDM::SepsisData& out)
  {
    Scenario::UnMarshall(static_cast<const SEPatientAction&>(in), static_cast<CDM::PatientActionData&>(out));
    if (in.HasCompartment()) {
      out.Compartment(in.m_Compartment);

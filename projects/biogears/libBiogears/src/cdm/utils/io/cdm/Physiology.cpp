...
namespace io {
  ...
  void Physiology::Marshall(const CDM::InflammationStateData& in, SEInflammationState& out)
  {
    io::Property::Marshall(in.Pathogen(), out.GetPathogen());
    ...
    io::Property::Marshall(in.InducibleNOSynthasePre(), out.GetInducibleNOSynthasePre());
    io::Property::Marshall(in.InducibleNOSynthase(), out.GetInducibleNOSynthase());
    io::Property::Marshall(in.ConstitutiveNOSynthase(), out.GetConstitutiveNOSynthase());
  ...
  //----------------------------------------------------------------------------------
  void Physiology::UnMarshall(const SEInflammationState& in, CDM::InflammationStateData& out)
  {
    io::Property::UnMarshall(*in.m_Pathogen, out.Pathogen());
    ...
    io::Property::UnMarshall(*in.m_InducibleNOSynthasePre, out.InducibleNOSynthasePre());
    io::Property::UnMarshall(*in.m_InducibleNOSynthase, out.InducibleNOSynthase());
    io::Property::UnMarshall(*in.m_ConstitutiveNOSynthase, out.ConstitutiveNOSynthase());
  ...
  void Physiology::Marshall(const CDM::BloodChemistrySystemData& in, SEBloodChemistrySystem& out)
  {
    ...
    Marshall(in.AcuteInflammatoryResponse(), out.GetAcuteInflammatoryResponse());
  }
  //----------------------------------------------------------------------------------
  void Physiology::UnMarshall(const SEBloodChemistrySystem& in, CDM::BloodChemistrySystemData& out)
  {
    ...
    if (in.m_AcuteInflammatoryResponse != nullptr) {
      UnMarshall(*in.m_AcuteInflammatoryResponse, out.AcuteInflammatoryResponse());
    }
  }
  //----------------------------------------------------------------------------------
  ...
  void Physiology::Marshall(const CDM::DrugSystemData& in, SEDrugSystem& out)
  {
    ...
    Marshall(in.PupillaryResponse(), out.GetPupillaryResponse());
  ...
  void Physiology::UnMarshall(const SEDrugSystem& in, CDM::DrugSystemData& out)
  {
    ...
    if (in.m_PupillaryResponse != nullptr) {
      UnMarshall(*in.m_PupillaryResponse, out.PupillaryResponse());
    }
  ...
  {
    System::Marshall(static_cast<const CDM::SystemData&>(in), static_cast<SESystem&>(out));
    io::Property::Marshall(in.BaroreceptorHeartRateScale(), out.GetBaroreceptorHeartRateScale());
    io::Property::Marshall(in.BaroreceptorHeartElastanceScale(), out.GetBaroreceptorHeartElastanceScale());
    io::Property::Marshall(in.BaroreceptorResistanceScale(), out.GetBaroreceptorResistanceScale());
    io::Property::Marshall(in.BaroreceptorComplianceScale(), out.GetBaroreceptorComplianceScale());
    io::Property::Marshall(in.ChemoreceptorHeartRateScale(), out.GetChemoreceptorHeartRateScale());
    io::Property::Marshall(in.ChemoreceptorHeartElastanceScale(), out.GetChemoreceptorHeartElastanceScale());
  ...
  {
    System::UnMarshall(static_cast<const SESystem&>(in), static_cast<CDM::SystemData&>(out));
    if (in.m_BaroreceptorHeartRateScale != nullptr) {
      io::Property::UnMarshall(*in.m_BaroreceptorHeartRateScale, out.BaroreceptorHeartRateScale());
    }
    if (in.m_BaroreceptorHeartElastanceScale != nullptr) {
      io::Property::UnMarshall(*in.m_BaroreceptorHeartElastanceScale, out.BaroreceptorHeartElastanceScale());
    }
    if (in.m_BaroreceptorResistanceScale != nullptr) {
      io::Property::UnMarshall(*in.m_BaroreceptorResistanceScale, out.BaroreceptorResistanceScale());
    }
    if (in.m_BaroreceptorComplianceScale != nullptr) {
      io::Property::UnMarshall(*in.m_BaroreceptorComplianceScale, out.BaroreceptorComplianceScale());
    }
    if (in.m_ChemoreceptorHeartRateScale != nullptr) {
      io::Property::UnMarshall(*in.m_ChemoreceptorHeartRateScale, out.ChemoreceptorHeartRateScale());
    }
    if (in.m_ChemoreceptorHeartElastanceScale != nullptr) {
      io::Property::UnMarshall(*in.m_ChemoreceptorHeartElastanceScale, out.ChemoreceptorHeartElastanceScale());
    }

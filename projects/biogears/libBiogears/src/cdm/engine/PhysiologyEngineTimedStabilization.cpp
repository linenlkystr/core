...
//-------------------------------------------------------------------------------
void PhysiologyEngineTimedStabilization::Load(const char* file)
{
  Load(std::string{ file });
}
//-------------------------------------------------------------------------------
void PhysiologyEngineTimedStabilization::Load(const std::string& file)
{
  ...
  return io::EngineConfiguration::Marshall(*pData,*this);
}
//-------------------------------------------------------------------------------

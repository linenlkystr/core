...
public:
  ...
  //Renal
  bool HasAfferentArterioleResistanceOverride() const;
  SEScalarFlowResistance& GetAfferentArterioleResistanceOverride();
  double GetAfferentArterioleResistanceOverride(const FlowResistanceUnit& unit) const;
  bool HasGlomerularFiltrationRateOverride() const;
  SEScalarVolumePerTime& GetGlomerularFiltrationRateOverride();
  double GetGlomerularFiltrationRateOverride(const VolumePerTimeUnit& unit) const;
  bool HasReaborptionRateOverride() const;
  SEScalarVolumePerTime& GetReaborptionRateOverride();
  double GetReaborptionRateOverride(const VolumePerTimeUnit& unit) const;
...
protected:
  ...
  SEScalarFlowResistance* m_AfferentArterioleResistOR;
  SEScalarVolumePerTime* m_GlomerularFiltrationOR;
  SEScalarVolumePerTime* m_ReabsorptionRateOR;

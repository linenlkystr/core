...
void BioGearsSubstances::InitializeLiquidCompartmentGases()
{
  ...
  if (!m_data.GetConfiguration().IsBioGearsLiteEnabled()) {
    ...
    //SELiquidCompartment& cmpt, double Hb_total_mM, double O2_sat, double O2_mmol_Per_L, double CO2_sat, double CO2_mmol_Per_L, double HCO3_mmol_Per_L, double pH, bool distribute
    // Bootstrapped values from many runs (using standard patient)
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::Gut), Hb_total_mM, 0.84134, 0.063322, 0.117408, 1.38086, 26.077, 7.37608);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftAfferentArteriole), Hb_total_mM, 0.927186, 0.0870192, 0.0595885, 1.35232, 26.0285, 7.38437);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftEfferentArteriole), Hb_total_mM, 0.907413, 0.0791142, 0.072315, 1.35842, 26.0389, 7.38259);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftGlomerularCapillaries), Hb_total_mM, 0.9209, 0.0773075, 0.031322, 1.07857, 25.5034, 7.47375);
    //No Hb through glomerular ultrafiltration
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftBowmansCapsules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 0.0, 7.47375);
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftTubules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 0.0, 7.47375);
    //----------------------------------------
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftPeritubularCapillaries), Hb_total_mM, 0.89667, 0.0757891, 0.0873866, 1.36599, 26.0518, 7.38039);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::PulmonaryArteries), Hb_total_mM, 0.813117, 0.0591941, 0.146207, 1.39669, 26.1035, 7.3716);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::PulmonaryCapillaries), Hb_total_mM, 0.983029, 0.149863, 0.0281766, 1.29193, 25.9223, 7.40244);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::PulmonaryVeins), Hb_total_mM, 0.974924, 0.129359, 0.0282471, 1.29371, 25.9255, 7.40189);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftRenalArtery), Hb_total_mM, 0.941145, 0.0945363, 0.0484668, 1.34704, 26.0194, 7.38592);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::LeftRenalVein), Hb_total_mM, 0.859657, 0.0668517, 0.112249, 1.37857, 26.0731, 7.37676);
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightAfferentArteriole), Hb_total_mM, 0.927186, 0.0870192, 0.0595885, 1.35232, 26.0285, 7.38437);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightEfferentArteriole), Hb_total_mM, 0.907413, 0.0791142, 0.072315, 1.35842, 26.0389, 7.38259);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightGlomerularCapillaries), Hb_total_mM, 0.9209, 0.0773075, 0.031322, 1.07857, 25.5034, 7.47375);
    //No Hb through glomerular ultrafiltration
    //InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightBowmansCapsules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 25.5034, 7.47375);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightBowmansCapsules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 0.0, 7.47375);
    //InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightTubules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 25.5034, 7.47375);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightTubules), 0.0, 0.0, 0.0773075, 0.0, 1.07857, 0.0, 7.47375);
    //----------------------------------------
    ...
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightPeritubularCapillaries), Hb_total_mM, 0.89667, 0.0757891, 0.0873866, 1.36599, 26.0518, 7.38039);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightRenalArtery), Hb_total_mM, 0.941145, 0.0945363, 0.0484668, 1.34704, 26.0194, 7.38592);
    InitializeBloodGases(*cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::RightRenalVein), Hb_total_mM, 0.859657, 0.0668517, 0.112249, 1.37857, 26.0731, 7.37676);
    ...
    InitializeBloodGases(*cmpts.GetTissueCompartment(BGE::TissueLiteCompartment::Kidney), *cmpts.GetLiquidCompartment(BGE::VascularLiteCompartment::Kidneys));
...
void BioGearsSubstances::InitializeLiquidCompartmentNonGases()
{
  ...
  if (m_data.GetConfiguration().IsBioGearsLiteEnabled()) {
    leftBowmansCapsules = m_data.GetCompartments().GetLiquidCompartment(BGE::VascularLiteCompartment::LeftBowmansCapsules);
    rightBowmansCapsules = m_data.GetCompartments().GetLiquidCompartment(BGE::VascularLiteCompartment::RightBowmansCapsules);
    leftTubules = m_data.GetCompartments().GetLiquidCompartment(BGE::VascularLiteCompartment::LeftTubules);
    rightTubules = m_data.GetCompartments().GetLiquidCompartment(BGE::VascularLiteCompartment::RightTubules);
  }
